...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('admin-assets/plugins/dropzone/min/dropzone.min.css') }}">
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2024 <span style="color: blueviolet"> Laravel Shop by Ubaid </span> rights
                reserved.
        </footer>
